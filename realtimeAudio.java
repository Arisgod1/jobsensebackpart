...
@Component
@ServerEndpoint(value = "/realtime/audio/websocket/{sid}/{stopFlag}")
@Slf4j
...
//存放会话对象
  ...
  //  private static final String apikey="";
    ...
    @OnMessage()
    public void onMessage(ByteBuffer  message) throws InterruptedException {
    ...
    public void onMessage(String message) throws InterruptedException {
        if(message.equals("-1")){
            ...
            log.info("收到标志位，准备发送给ai");
            //刺激一下通道，让他结束任务
            Map<String, Object> connect = apiWebsocket.connect();
            apiWebsocket.sendMessage(ByteBuffer.wrap(message.getBytes()),(Session)connect.get("session"));
        }
        //建立一把锁，知道问题返回，在返回给前端
